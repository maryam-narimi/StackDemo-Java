...
This Java program demonstrates the implementation of a **Stack** data structure with basic operations: **Push** (add an element) and **Pop** (remove the top element). 
The program allows user interaction via a simple menu to perform stack operations and display the current stack contents.
